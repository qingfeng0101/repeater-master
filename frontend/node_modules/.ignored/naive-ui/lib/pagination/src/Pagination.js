...
exports.paginationProps = Object.assign(Object.assign({}, _mixins_1.useTheme.props), { simple: Boolean, page: Number, defaultPage: {
        ...
        type: Number,
        default: 9
    }, prev: Function, next: Function, prefix: Function, suffix: Function, label: Function, displayOrder: {
        type: Array,
...
exports.default = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        const { $slots, mergedClsPrefix, disabled, cssVars, mergedPage, mergedPageCount, pageItems, showSizePicker, showQuickJumper, mergedTheme, locale, inputSize, selectSize, mergedPageSize, pageSizeOptions, jumperValue, simple, prev, next, prefix, suffix, label, handleJumperInput, handleSizePickerChange, handleBackwardClick, handlePageItemClick, handleForwardClick, handleQuickJumperChange, onRender } = this;
        ...
        return ((0, vue_1.h)("div", { ref: "selfRef", class: [
            ...
            this.displayOrder.map((part) => {
                switch (part) {
                    ...
                    case 'size-picker': {
                        return !simple && showSizePicker ? ((0, vue_1.h)(select_1.NSelect, { to: this.to, placeholder: "", showCheckmark: false, size: selectSize, options: pageSizeOptions, value: mergedPageSize, disabled: disabled, theme: mergedTheme.peers.Select, themeOverrides: mergedTheme.peerOverrides.Select, onUpdateValue: handleSizePickerChange })) : null;
                    }
                    case 'quick-jumper':

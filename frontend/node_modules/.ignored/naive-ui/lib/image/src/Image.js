...
exports.default = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        const imgNode = (0, vue_1.h)('img', Object.assign(Object.assign({}, imgProps), { class: imgProps.class, ref: 'imageRef', width: this.width || imgProps.width, height: this.height || imgProps.height, src: is_native_lazy_load_1.isImageSupportNativeLazy
                ? loadSrc
                : this.showError
                    ? this.fallbackSrc
